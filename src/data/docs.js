    ...
    items: [
      {
        ...
        response: { success: true, stats: { totalUsers: 'number', totalOrders: 'number', totalSpent: 'number' } }
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        response: { success: true, status: 'operational', users: 'number', products: 'number', orders: 'number' }
      },
      {
        method: 'GET',
        path: '/api/events',
        description: 'Get activity log events',
        response: { success: true, events: [{ id: 'uuid', type: 'string', summary: 'string', timestamp: 'date' }] }
      }
    ]
  }
];
